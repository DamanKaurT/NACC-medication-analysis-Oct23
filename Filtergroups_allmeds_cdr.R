...
write.csv(df, file = "NtoDcdrcox.csv",row.names=FALSE, na="")
...
df$Diagnosis[(df$Diagnosis == 'TRUE' )]<- 1
df <- df[,-(129)] 
write.csv(df, file = "NtoMcdrcox.csv",row.names=FALSE, na="")
...
df$Diagnosis[(df$Diagnosis == 'TRUE' )]<- 1
df <- df[,-(129)] 
write.csv(df, file = "MtoDcdrcox.csv",row.names=FALSE, na="")
